...
**같은 대기 시간 설정을 두 곳에 사용합니다.** 상자를 처음 발견하면 그 범위에서 시간을 정해 기다리고, 개봉 사이에도 같은 범위의 대기를 둡니다. 두 대기는 동시에 진행하며 둘 다 끝난 뒤 개봉합니다. 예를 들어 발견 후 대기가 5초이고 이전 개봉의 남은 대기가 2초라면, 약 5초 후 개봉할 수 있습니다. 두 시간을 더하지 않습니다. 약 0.5초의 확인 주기, 다른 상자의 처리와 게임 상태 때문에 실제 개봉은 더 늦어질 수 있습니다. 설정을 바꾸면 이후 새로 발견하는 상자부터 새 범위로 대기합니다.
